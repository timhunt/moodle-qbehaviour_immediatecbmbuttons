...
/**
 * This file contains tests that walks a question through the CBM with immediate
 * submit behaviour.
 *
...
/**
 * Unit tests for the CBM with immediate submit behaviour.
 *
 * @copyright 2012 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_immediatecbmbuttons_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_immediatecbmbuttons_feedback_multichoice_right() {
    ...
    public function test_immediatecbmbuttons_feedback_multichoice_try_to_submit_blank() {
    ...
    public function test_immediatecbmbuttons_feedback_shortanswer_try_to_submit_no_certainty() {
    ...
    public function test_immediatecbmbuttons_feedback_multichoice_wrong_on_finish() {
    ...
    public function test_immediatecbmbuttons_cbm_truefalse_no_certainty_feedback_when_not_answered() {
